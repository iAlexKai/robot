...
def cal_dist_speed(pair, frame_time_diff):
    car_posi_0 = pair[0]  # 第一帧车的位置信息[{'frame_id', 'left', 'right', ..., 'center', 'id'}]
    car_posi_1 = pair[1]  # 第二帧车的位置信息[{'frame_id', 'left', 'right', ..., 'center', 'id'}]
    for car_1 in car_posi_1:
        _, car1_2_cam = cal_speed_pixel(0, car_1['down'], frame_time_diff)
        car_1.update({'car_speed': 0})
        car_1.update({'car_2_cam': car1_2_cam})
        for car_0 in car_posi_0:
            if car_0['id'] == car_1['id']:
                car_speed, car1_2_cam = cal_speed_pixel(car_0['down'], car_1['down'], frame_time_diff)
                car_1.update({'car_speed': car_speed})
                car_1.update({'car_2_cam': car1_2_cam})
    print('=============')
...
if __name__ == "__main__":
    ...
    pair_2 = [[{'frame_id': 0, 'center': (260, 220), 'id': 1, 'down': 165}], \
            [{'frame_id': 1, 'center': (198, 226), 'down': 182, 'id': 1}, {'frame_id': 1, 'center': (100, -75), 'down': 191, 'id': 2}, \
             {'frame_id': 1, 'center': (140, 1000), 'down': 191, 'id': 3}, {'frame_id': 1, 'center': (225, 127), 'down': 191, 'id': 4}]]

    #print(search_one_car_init_0(pair_1))
    print(cal_dist_speed(pair_2, 0.01))
