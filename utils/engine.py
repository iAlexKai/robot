...
#        print(' ', '-' * 2, 'Confidence:  ',     self.conf)
        print("left:{} right:{} top:{} down:{} area:{} centre:{}".format(self.x_min, self.x_max, self.y_min, 
self.y_max, self.area, self.center))
...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, boxes, confs, clss, frame_id):
        car_info_list = []
...
#                obj.print_info()  # print object info
        ...
        return img, visualize_time, car_info_list
